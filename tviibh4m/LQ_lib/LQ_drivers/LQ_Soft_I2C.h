...
*******************************************************************************/
#ifndef _LQ_SOFT_IIC_H_
#define _LQ_SOFT_IIC_H_
...
#define SOFT_IIC_SCL_PIN   P12_2   /*!< P13_1  作为 SCL */
#define SOFT_IIC_SDA_PIN   P12_1   /*!< P13_2  作为 SDA */

#define SDA_OUT        LQ_GPIO_Init_Config(SOFT_IIC_SDA_PIN, GPIO_OUT_STRONG);
#define SDA_IN         LQ_GPIO_Init_Config(SOFT_IIC_SDA_PIN, GPIO_IN_HIGHZ);

#define IIC_SCL_INIT   LQ_GPIO_Init_Config(SOFT_IIC_SCL_PIN, GPIO_OUT_STRONG);
#define IIC_SDA_INIT   LQ_GPIO_Init_Config(SOFT_IIC_SDA_PIN, GPIO_OUT_STRONG);

#define IIC_SCL_H      LQ_Pin_Write(SOFT_IIC_SCL_PIN, 1);
#define IIC_SCL_L      LQ_Pin_Write(SOFT_IIC_SCL_PIN, 0);

#define IIC_SDA_H      LQ_Pin_Write(SOFT_IIC_SDA_PIN, 1);
#define IIC_SDA_L      LQ_Pin_Write(SOFT_IIC_SDA_PIN, 0);

#define IIC_SDA_READ   LQ_Pin_Read_In(SOFT_IIC_SDA_PIN)
