...
#define CY_CB_USER_LED1_PORT                    GPIO_PRT5
#define CY_CB_USER_LED1_PIN                     4
#define CY_CB_USER_LED1_PIN_MUX                 P5_4_GPIO

#define CY_CB_USER_LED2_PORT                    GPIO_PRT8
#define CY_CB_USER_LED2_PIN                     3
#define CY_CB_USER_LED2_PIN_MUX                 P8_3_GPIO
