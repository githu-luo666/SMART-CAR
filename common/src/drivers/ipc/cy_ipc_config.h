...
#define CY_IPC_CHAN_PIPE_EP0                 5    /**< IPC data channel for PIPE EP0 */
#define CY_IPC_CHAN_PIPE_EP1                 6    /**< IPC data channel for PIPE EP1 */

#define CY_IPC_CHAN_PIPE_EP2                 7    /**< IPC data channel for PIPE EP2 */
...
#define CY_IPC_PIPE_MAX_ENDPOINTS            3    /**< Number of pipe endpoints (each endpoint needs its own IPC channel and IPC Intr. struct */
...
#define CY_IPC_INTR_PIPE_EP0                 5                  /**< IPC Interrupt Structure Index, used as notifier for EP0 */
#define CY_IPC_INTR_PIPE_CPU_INT_IDX_EP1     CPUIntIdx2_IRQn    /**< CPU Interrupt Index, used in the EP1 CPU */
#define CY_IPC_INTR_PIPE_EP1                 6                  /**< IPC Interrupt Structure Index, used as notifier for EP1 */

#define CY_IPC_INTR_PIPE_CPU_INT_IDX_EP2     CPUIntIdx2_IRQn    /**< CPU Interrupt Index, used in the EP2 CPU */
#define CY_IPC_INTR_PIPE_EP2                 7                  /**< IPC Interrupt Structure Index, used as notifier for EP2 */
...
{                                                              \
    ...
    {                                                          \
        .ipcStructNr     = CY_IPC_CHAN_PIPE_EP2,               \
        .ipcIntrStructNr = CY_IPC_INTR_PIPE_EP2,               \
        .ipcCpuIntIdx    = CY_IPC_INTR_PIPE_CPU_INT_IDX_EP2,   \
    },                                                         \
}
